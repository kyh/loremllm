...
export type OpenInProviderProps = ComponentProps<typeof DropdownMenuItem> & {
  provider: ProviderKey;
};

const OpenInProvider = ({ provider, ...props }: OpenInProviderProps) => {
