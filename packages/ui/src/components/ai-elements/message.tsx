...
export const MessageContent = ({ children, className, ...props }: MessageContentProps) => (
  <div
    className={cn(
      ...
      "group-[.is-user]:bg-secondary group-[.is-user]:text-foreground group-[.is-user]:rounded-lg group-[.is-user]:px-4 group-[.is-user]:py-3",
...
const MessageResponseComponent = ({ className, ...props }: MessageResponseProps) => (
  <Streamdown
