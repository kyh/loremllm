...
/* oxlint-disable jsx-a11y/prefer-tag-over-role -- <fieldset> changes default styling and form semantics */
/* oxlint-disable jsx-a11y/click-events-have-key-events, jsx-a11y/no-noninteractive-element-interactions -- pointer convenience only: a click on the addon focuses the control, which keyboard users reach by Tab */
